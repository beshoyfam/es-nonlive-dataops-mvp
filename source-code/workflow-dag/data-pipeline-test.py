...
with models.DAG(
  ...
  trigger_post_run_dag = TriggerDagRunOperator(
        task_id="trigger_post_run_dag",
        trigger_dag_id="post_run_dag",  # Ensure this equals the dag_id of the DAG to trigger
        execution_date = '{{ds}}',
        reset_dag_run = True ,
        conf={"main_dag": "test_word_count", 
        "run_id": "$run_id",
